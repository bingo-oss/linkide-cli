module.exports = {
    ...
    rules: {
        ...
        // @off 不作限制
        'func-style': 'off',
        // @fixable enforce consistent line breaks inside function parentheses
        ...
        // @off 不作限制
        'id-match': 'off',
        // @fixable enforce the location of arrow function bodies
        ...
        // @fixable require or disallow an empty line between class members
        // @off
        ...
        // 限制回调函数嵌套的层数，过多时需要使用 async await 替代
        ...
        // @fixable enforce a particular style for multiline comments
        // @off
        ...
        // @fixable 使用表达更简单的三元操作符，如 !a 代替 a ? false : true
        ...
        // @fixable 要求或禁止尽可能地简化赋值操作，如 x += y 代替 x = x + y
        ...
        // @fixable disallow using Object.assign with an object literal as the first argument
        ...
        // @fixable 要求使用箭头函数作为回调
        'prefer-arrow-callback': 'error',
        // @fixable 声明后不再修改的变量必须使用 const 声明
        'prefer-const': 'error',
        // 必须使用解构
        // @off 不作限制
